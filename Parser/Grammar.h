...
const std::unordered_map<RuleType, std::vector<std::string> > RHS = {
        ...
        {RuleType::REL_EXPRESSION,                      {"ARITH_EXPRESSION COMPARE_OP ARITH_EXPRESSION",       "#"}},
        ...
        {RuleType::VARIABLE_DECLARATIONS,               {"TYPE VARIABLE_DECLARATION VARIABLE_DECLARATIONS",          "#"}},
        ...
        {RuleType::FUNCTION_BODY,                       {"LOCAL_SCOPE do STATEMENTS end"}},
...
const std::unordered_map<RuleType, std::unordered_set<std::string>> FIRST = {
        ...
        {RuleType::COMPARE_OP,                          {"==", "<>", "<", ">", "<=", ">="}},
        {RuleType::INDEX,                               {"["}},
        {RuleType::VARIABLE_DECLARATIONS,               {"id", "__Integer", "__Float"}},
...
const std::unordered_map<std::string, Rule*> RULES = {
        ...
        {"VARIABLE_OR_FUNCTION_CALL", new Rule(RuleType::VARIABLE_OR_FUNCTION_CALL, FIRST.at(RuleType::VARIABLE_OR_FUNCTION_CALL), FOLLOW.at(RuleType::VARIABLE_OR_FUNCTION_CALL), RHS.at(RuleType::VARIABLE_OR_FUNCTION_CALL), true)},
        ...
        {"FACTOR_FUNCTION_CALL", new Rule(RuleType::FACTOR_FUNCTION_CALL, FIRST.at(RuleType::FACTOR_FUNCTION_CALL), FOLLOW.at(RuleType::FACTOR_FUNCTION_CALL), RHS.at(RuleType::FACTOR_FUNCTION_CALL), true)},
